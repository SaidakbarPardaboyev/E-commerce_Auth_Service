...
func (x *Products) GetCount() int32 {
	if x != nil {
		return x.Count
	}
	return 0
...
var file_user_service_proto_rawDesc = []byte{
	...
	0x0a, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x87, 0x02, 0x0a, 0x04,
	...
	0x6f, 0x72, 0x64, 0x48, 0x61, 0x73, 0x68, 0x12, 0x14, 0x0a, 0x05, 0x70, 0x68, 0x6f, 0x6e, 0x65,
	...
	0x61, 0x67, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28,
	...
	0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0xed, 0x01, 0x0a, 0x07, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63,
	...
	0x74, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x64, 0x69, 0x73, 0x63, 0x6f, 0x75, 0x6e,
	0x74, 0x12, 0x14, 0x0a, 0x05, 0x73, 0x74, 0x6f, 0x63, 0x6b, 0x18, 0x07, 0x20, 0x01, 0x28, 0x03,
	...
	0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0x53, 0x0a, 0x08, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74,
	...
	0x01, 0x28, 0x05, 0x52, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x32, 0xcd, 0x02, 0x0a, 0x0b, 0x55,
	0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x3a, 0x0a, 0x0a, 0x47, 0x65,
	0x74, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x12, 0x18, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x5f,
	...
	0x65, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x12, 0x37, 0x0a, 0x0d, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x12, 0x12, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x5f, 0x73,
	...
	0x41, 0x0a, 0x0d, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65,
	...
	0x74, 0x79, 0x12, 0x45, 0x0a, 0x11, 0x52, 0x65, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x64, 0x50,
	0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x73, 0x12, 0x18, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x5f, 0x73,
	...
	0x2e, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x73, 0x12, 0x3f, 0x0a, 0x0b, 0x47, 0x65, 0x74,
	0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x73, 0x12, 0x18, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x5f,
	0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x50, 0x72, 0x69, 0x6d, 0x61, 0x72, 0x79, 0x4b,
	0x65, 0x79, 0x1a, 0x16, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x2e, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x73, 0x42, 0x17, 0x5a, 0x15, 0x67, 0x65,
...
var file_user_service_proto_goTypes = []interface{}{
	...
	(*Product)(nil),     // 1: auth_service.Product
	(*Products)(nil),    // 2: auth_service.Products
	(*PrimaryKey)(nil),  // 3: auth_service.PrimaryKey
	(*empty.Empty)(nil), // 4: google.protobuf.Empty
}
var file_user_service_proto_depIdxs = []int32{
	1, // 0: auth_service.Products.products:type_name -> auth_service.Product
	3, // 1: auth_service.UserService.GetProfile:input_type -> auth_service.PrimaryKey
	0, // 2: auth_service.UserService.UpdateProfile:input_type -> auth_service.User
	3, // 3: auth_service.UserService.DeleteProfile:input_type -> auth_service.PrimaryKey
	3, // 4: auth_service.UserService.RecommendProducts:input_type -> auth_service.PrimaryKey
	3, // 5: auth_service.UserService.GetProducts:input_type -> auth_service.PrimaryKey
	0, // 6: auth_service.UserService.GetProfile:output_type -> auth_service.User
	0, // 7: auth_service.UserService.UpdateProfile:output_type -> auth_service.User
	4, // 8: auth_service.UserService.DeleteProfile:output_type -> google.protobuf.Empty
	2, // 9: auth_service.UserService.RecommendProducts:output_type -> auth_service.Products
	2, // 10: auth_service.UserService.GetProducts:output_type -> auth_service.Products
